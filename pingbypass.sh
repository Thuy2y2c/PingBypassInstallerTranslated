...
read -p 'Please enter your Internal Port do you want it to be setted >> ' openport
read -p 'Please enter your PingBypass Password do you want it to be setted >> ' pass
read -p 'Please enter your Minecraft (Microsoft) email here >> ' email
read -p 'Please enter your Minecraft (Microsoft) account password here >> ' password
